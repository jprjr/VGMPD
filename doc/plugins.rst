...
Video game music file emulator based on `libvgm <https://github.com/ValleyBell/libvgm>`_.
...
.. list-table::
   ...
   * - Setting
     - Description
   * - **sample_rate**
     - Sets the sample rate generated by libvgm. Default is 44100.
   * - **bit_depth 16|24**
     - Sets the bit depth output by libvgm. Default is 16.
   * - **fade_len**
     - Length of fade to add to looping tracks, in seconds. Default is 8.
